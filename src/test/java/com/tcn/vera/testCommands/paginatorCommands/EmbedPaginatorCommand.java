...
public class EmbedPaginatorCommand extends SlashCommandTemplate {

    final ButtonHandler buttonHandler;

   public EmbedPaginatorCommand(ButtonHandler buttonHandler) {
       this.buttonHandler = buttonHandler;
       this.commandName = "embed_paginator_test";
   }
