 ...
 *                 .addCommand(new exampleSlashCommand())  //<--- the command that we want to register
 *                 .build();
 *
 ...
 * it is important to note that the commandName field must be unique amongst any other slash commands. If any fields
 ...
 * <p>
 * Additionally, this class will automatically generate a {@link CommandData} object based upon the given command name and help strings.
 ...
 * <blockquote><pre>
 *     public ExampleSlashCommand(){
 *         this.commandName = "slash-command-example";
